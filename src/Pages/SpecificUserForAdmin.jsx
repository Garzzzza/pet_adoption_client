...
const SpecificUserForAdmin = () => {
    ...
    const {
        savedPetsArray, adoptedPetsArray, getSavedPetsArray, getAdoptedPetsArray, renderAdoptedPetsForUser, renderSavedPetsForUser
    ...
    useEffect(() => {
        ...
        getSomeUserById(userId); console.log(someUser)
    }, [userId])
