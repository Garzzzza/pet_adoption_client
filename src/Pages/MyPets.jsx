...
const MyPets = () => {
    ...
    const { savedPetsArray, setSavedPetsArray, getSavedPetsArray,
        addAdoptedPet, getAdoptedPetsArray, adoptedPetsArray, setAdoptedPetsArray, deleteAdoptedPet, renderSavedPetsForUser, renderAdoptedPetsForUser,
        fosteredPetsArray, setFosteredPetsArray, addFosteredPet, getFosteredPetsArray, deleteFosteredPet, renderFosteredPetsForUser, } = useContext(PetUserContext)
    ...
    return (
        <div>
            ...
            <div>
                ...
                <div className="petsDiv">
                    {fosteredPetsArray.length > 0 && renderFosteredPetsForUser(currentUser)}
                </div>
            </div>
