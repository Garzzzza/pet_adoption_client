...
function PetUserContextProvider({ children }) {
    ...
    try {
      const response = await axios.post(
        process.env.REACT_APP_SERVER_URL +
          "/petsUsersInteraction/savedpets/" +
          userId +
          "/" +
          petId,
        {},
  ...
  async function getSavedPetsArray() {
    try {
      const response = await axios.get(
        process.env.REACT_APP_SERVER_URL + "/petsUsersInteraction/savedpets",
        { headers: { Authorization: "Bearer " + token } }
      );
  ...
  async function addFosteredPet(userId, petId) {
    try {
      ...
      const postResponse = await axios.post(
        process.env.REACT_APP_SERVER_URL +
          "/petsUsersInteraction/fosteredpets/" +
          userId +
          "/" +
          petId,
        {},
  ...
  async function getFosteredPetsArray() {
    try {
      const response = await axios.get(
        process.env.REACT_APP_SERVER_URL + "/petsUsersInteraction/fosteredpets",
        { headers: { Authorization: "Bearer " + token } }
      );
  ...
  async function addAdoptedPet(userId, petId) {
    try {
      ...
      const postResponse = await axios.post(
        process.env.REACT_APP_SERVER_URL +
          "/petsUsersInteraction/adoptedpets/" +
          userId +
          "/" +
          petId,
        {},
  ...
  async function getAdoptedPetsArray() {
    try {
      const response = await axios.get(
        process.env.REACT_APP_SERVER_URL + "/petsUsersInteraction/adoptedpets",
        { headers: { Authorization: "Bearer " + token } }
      );
  ...
  function renderSavedPetsForUser(relevantUser) {
    return savedPetsArray
      .filter((pet) => pet.userId == relevantUser.userId)
      .map((pet) => {
